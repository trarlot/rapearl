...
/**
 * Composant de boutons de contrôle audio en fullscreen.
 *
 * @component
 * @example
 * <Buttons />
 *
 * @description
 * Le composant Buttons affiche des boutons pour contrôler la lecture audio,
 * y compris le mode aléatoire, la musique précédente, lecture/pause, musique suivante,
